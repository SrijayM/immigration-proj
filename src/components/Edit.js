...
const Edit = ({immigrate}) => {

    const location = useLocation();
    const num = location.state.num;
    
        const [formData, setFormData] = useState({
            alien_reg_num: immigrate?(immigrate[num].alien_reg_num):(""), 
            apt: immigrate?(immigrate[num].apt):(false) ,
            arrive_dep_num: immigrate?(immigrate[num].arrive_dep_num):(""),
            birth_country: immigrate?(immigrate[num].birth_country):(""),
            birth_province: immigrate?(immigrate[num].birth_province):(""),
            citizenship_country: immigrate?(immigrate[num].citizenship_country):(""),
            city_town: immigrate?(immigrate[num].city_town):(""),
            consulate: immigrate?(immigrate[num].consulate):(false),
            curr_nonimmigrant_status: immigrate?(immigrate[num].curr_nonimmigrant_status):(""),
            ead_num: immigrate?(immigrate[num].ead_num):(""),
            entry_port: immigrate?(immigrate[num].entry_port):(false),
            flr: immigrate?(immigrate[num].flr):(false),
            foreign_apt: immigrate?(immigrate[num].foreign_apt):(false),
            foreign_city_town: immigrate?(immigrate[num].foreign_city_town):(""),
            foreign_country: immigrate?(immigrate[num].foreign_country):(""),
            foreign_flr: immigrate?(immigrate[num].foreign_flr):(false),
            foreign_num: immigrate?(immigrate[num].foreign_num):(""),
            foreign_postal_code: immigrate?(immigrate[num].foreign_postal_code):(""),
            foreign_province: immigrate?(immigrate[num].foreign_province):(""),
            foreign_states: immigrate?(immigrate[num].foreign_states):(""),
            foreign_ste: immigrate?(immigrate[num].foreign_ste):(false),
            foreign_street_num_name: immigrate?(immigrate[num].foreign_street_num_name):(""),
            last_arrival_date: immigrate?(immigrate[num].last_arrival_date):(""),
            num: immigrate?(immigrate[num].num):(""),
            office_address: immigrate?(immigrate[num].office_address):(""),
            passport_doc_num: immigrate?(immigrate[num].passport_doc_num):(""),
            passport_expiry_date: immigrate?(immigrate[num].passport_expiry_date):(""),
            passport_issue_country: immigrate?(immigrate[num].passport_issue_country):(""),
            passport_issue_date: immigrate?(immigrate[num].passport_issue_date):(""),
            passport_valid_no: immigrate?(immigrate[num].passport_valid_no):(false),
            passport_valid_yes: immigrate?(immigrate[num].passport_valid_yes):(false),
            pre_flight_inspec: immigrate?(immigrate[num].pre_flight_inspec):(false),
            sevis_num: immigrate?(immigrate[num].sevis_num):(""),
            state_foreign_country: immigrate?(immigrate[num].state_foreign_country):(""),
            states: immigrate?(immigrate[num].states):(""),
            status_exp_date: immigrate?(immigrate[num].status_exp_date):(""),
            ste: immigrate?(immigrate[num].ste):(false),
            street_num_name: immigrate?(immigrate[num].street_num_name):(""),
            zip_code: immigrate?(immigrate[num].zip_code):("")
        });
  ...
  return (
    <div>
        <div className='new-bg'>
            ...
            <p className='title2'>Edit Form</p>
